...
pub struct ClusterConfig {
    ...
    #[cfg(feature = "cluster-async")]
    pub(crate) connection_addr_selection: Option<crate::client::AsyncConnectionAddrSelection>,
}
...
impl ClusterConfig {
    ...
    pub fn set_connection_addr_selection(
        mut self,
        connection_addr_selection: crate::client::AsyncConnectionAddrSelection,
    ) -> Self {
